...
def safe_eval(expr, globals_dict=None, locals_dict=None, mode="eval", nocopy=False, locals_builtins=False):
    ...
    except actpy.exceptions.except_orm:
        raise
    except actpy.exceptions.Warning:
        raise
    except actpy.exceptions.RedirectWarning:
        raise
    except actpy.exceptions.AccessDenied:
        raise
    except actpy.exceptions.AccessError:
        raise
    except werkzeug.exceptions.HTTPException:
        raise
    except actpy.http.AuthenticationError:
        raise
