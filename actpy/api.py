...
from actpy.tools import frozendict, classproperty
...
def constrains(*args):
    ...
    Should raise :class:`~actpy.exceptions.ValidationError` if the
    validation failed.
...
def one(method):
    """ Decorate a record-style method where ``self`` is expected to be a
        ...
        .. deprecated:: 9.0
            ...
            is a single record with :meth:`~actpy.models.Model.ensure_one`.
    """
...
from actpy.exceptions import UserError, AccessError, MissingError
