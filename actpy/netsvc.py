...
class PostgreSQLHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        if not dbname:
            return
        with tools.ignore(Exception), tools.mute_logger('actpy.sql_db'), sql_db.db_connect(dbname, allow_uri=True).cursor() as cr:
            cr.autocommit(True)
...
DEFAULT_LOG_CONFIGURATION = [
    'actpy.http.rpc.request:INFO',
    'actpy.http.rpc.response:INFO',
    ':INFO',
]
PSEUDOCONFIG_MAPPER = {
    'debug_rpc_answer': ['actpy:DEBUG', 'actpy.sql_db:INFO', 'actpy.http.rpc:DEBUG'],
    'debug_rpc': ['actpy:DEBUG', 'actpy.sql_db:INFO', 'actpy.http.rpc.request:DEBUG'],
    'debug': ['actpy:DEBUG', 'actpy.sql_db:INFO'],
    'debug_sql': ['actpy.sql_db:DEBUG'],
    'info': [],
    'warn': ['actpy:WARNING', 'werkzeug:WARNING'],
    'error': ['actpy:ERROR', 'werkzeug:ERROR'],
    'critical': ['actpy:CRITICAL', 'werkzeug:CRITICAL'],
}
