...
from actpy.exceptions import except_orm, UserError
from actpy.tools import ustr, pycompat
...
class IrMailServer(models.Model):
    ...
    def _get_default_bounce_address(self):
        ...
        If "mail.bounce.alias" is not set it defaults to "postmaster-actpy".

        If "mail.catchall.domain" is not set, return None.

        '''
        get_param = self.env['ir.config_parameter'].sudo().get_param
        postmaster = get_param('mail.bounce.alias', default='postmaster-actpy')
