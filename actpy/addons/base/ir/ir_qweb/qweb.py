...
from actpy.tools import pycompat, freehash
    ...
    def _base_module(self):
        ...
        * string_types (replacement for basestring)
        ...
        return ast.parse(dedent("""
            ...
            from actpy.tools.pycompat import to_text, string_types
            from actpy.addons.base.ir.ir_qweb.qweb import escape, foreach_iterator
            """))
