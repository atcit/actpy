...
from actpy import fields, tools
from actpy.http import request
from actpy.modules.module import get_resource_path
import psycopg2
from actpy.tools import func, misc
        ...
        return """
            (function (message) {
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    if (typeof actpy === "undefined") return;

                    actpy.define("AssetsBundle.ErrorMessage", function (require) {
                        "use strict";
