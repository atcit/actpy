...
class Field(MetaField('DummyField', (object,), {})):
    """ The field descriptor contains the field definition, and manages accesses
        ...
        recordset. The decorator :meth:`actpy.api.depends` must be applied on
        ...
        is extended (see :class:`~actpy.models.Model`), one can also extend
    ...
    def cache_key(self, record):
        ...
        """
        env = record.env
        # IMPORTANT: actpy.api.Cache.get_records() depends on the fact that the
