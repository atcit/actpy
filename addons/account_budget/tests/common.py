...
from actpy.addons.account.tests.account_test_classes import AccountingTestCase
...
class TestAccountBudgetCommon(AccountingTestCase):
    ...
    def setUp(self):
        ...
        # In order to check account budget module in actpy I created a budget with few budget positions
