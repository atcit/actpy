...
from actpy import api, http, SUPERUSER_ID, _
from actpy.exceptions import AccessDenied
from actpy.http import request
from actpy import registry as registry_get

from actpy.addons.auth_signup.controllers.main import AuthSignupHome as Home
from actpy.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via actpy Account provider"""
