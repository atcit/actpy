...
from actpy.addons.hw_proxy.controllers import main as hw_proxy
...
<html>
    <head>
        <title>actpy's PosBox - Software Upgrade</title>
	...
	<p></p>
        ...
        the <a href='http://nightly.actpy.com/trunk/posbox/'>latest image</a>. The upgrade
        procedure is explained into to the
        <a href='https://www.actpy.com/documentation/user/point_of_sale/posbox/index.html'>PosBox manual</a>
        </p>
        <p>
        ...
        <pre>
"""
upgrade_template += subprocess.check_output("git --work-tree=/home/pi/actpy/ --git-dir=/home/pi/actpy/.git log -1", shell=True).replace("\n", "<br/>")
upgrade_template += """
        </pre>
        <div class='centering'>
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/actpy/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
