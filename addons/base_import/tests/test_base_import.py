...
from actpy.tests.common import TransactionCase, can_import
from actpy.modules.module import get_module_resource
from actpy.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('actpy.addons.base_import.models.base_import')
