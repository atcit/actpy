...
from actpy import models, api, fields
...
class pos_order(models.Model):
    ...
    def _check_hash_integrity(self, company_id):
        ...
        raise UserError(_('''Successful test !
                         ...
                         For this report to be legally meaningful, please download your certification from your customer account on actpy.com (Only for actpy Enterprise users).'''
                         ) % report_dict)
