actpy.define('survey.tour_test_survey', function (require) {
'use strict';
...
tour.register('test_survey', {
    ...
    [
        ...
        // Page-2
        // Question: What do you think about the documentation available on doc.actpy.com?
        {
        ...
        {
            content: "For 'I use the contextual help in actpy' checking 'Agree'",
        ...
        // Question: What do you think about the process views of actpy, available in the web client ?
        {
            content: "For 'They help new users to understand actpy' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to actpy?
        {
