...
Also, adds methods to convert values back to actpy models.
"""
...
from actpy import api, models, fields
from actpy.tools import ustr, pycompat
from actpy.tools import html_escape as escape
from actpy.addons.base.ir import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = actpy.modules.get_module_resource(
