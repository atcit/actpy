actpy.define('web_editor.web_editor_tests', function (require) {
"use strict";
        ...
        mockRPC: function (route, args) {
            ...
            if (_.str.startsWith(route, '/logo')) {
                ...
                return loadDeferred.then(function () {
                    var contentCallback = window.actpy[callback + '_content'];
                    var editorCallback = window.actpy[callback + '_editor'];
