actpy.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.actpy[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.actpy[callback + '_editor']) {
                window.top.actpy[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.actpy[callback + '_downup']) {
                    window.top.actpy[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
actpy.define('web_editor.IframeRoot.instance', function (require) {
'use strict';
...
actpy.define('web_editor.IframeRoot', function (require) {
'use strict';
