define(['summernote/core/range', 'summernote/core/dom'], function (range, dom) { // actpy: suggest upstream
  /**
  ...
  var History = function ($editable) {
    ...
    var makeSnapshot = function () {
      ...
      return {
        ...
        // actpy: suggest upstream added " && dom.ancestor(rng.sc, dom.isEditable) "
      };
    };
    ...
    var last; // actpy: to suggest upstream (since we may have several editor)
    /**
     * recorded undo
     */
    this.recordUndo = function () {
      // actpy: method totally rewritten
