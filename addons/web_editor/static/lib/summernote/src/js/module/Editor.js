define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // actpy: allow access for override
    this.table = table;   // actpy: allow access for override
    this.typing = typing; // actpy: allow access for override
    this.bullet = bullet; // actpy: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // actpy: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // actpy: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // actpy: adding this branch to modify existing anchor
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // actpy: addition
        $(anchor).css(linkInfo.style || {}); // actpy: addition
        if (isNewWindow) {
