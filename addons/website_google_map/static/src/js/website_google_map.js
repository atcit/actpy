function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('actpy-google-map'), {
        zoom: 1,
    ...
    if (actpy_partner_data){ /* actpy_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < actpy_partner_data.counter; i++) {
            set_marker(actpy_partner_data.partners[i]);
        }
