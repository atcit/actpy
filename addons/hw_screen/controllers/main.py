...
from actpy.addons.web.controllers import main as web
from actpy.addons.hw_posbox_homepage.controllers import main as homepage
...
class HardwareScreen(web.Home):
    ...
    def _get_html(self):
        ...
        html = """
            ...
            <html>
                <head>
                <title class="origin">actpy -- Point of Sale</title>
                ...
                <body class="original_body">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4">
                            ...
                            <p>actpy version 11 or above is required.</p>
                        </div>
                    </div>
                    </div>
                </body>
