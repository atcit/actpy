actpy.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.mediaVideo = Animation.extend({
    ...
    start: function () {
        ...
        // integrated with actpy (this refactoring should be done in master).
 ...
 *
 * This should be removed in a future actpy snippets refactoring.
 */
