...
from actpy import http, models, fields, _
from actpy.http import request
from actpy.tools import pycompat, OrderedSet
from actpy.addons.http_routing.models.ir_http import slug, _guess_mimetype
from actpy.addons.web.controllers.main import WebClient, Binary, Home
from actpy.addons.portal.controllers.portal import pager as portal_pager
...
class Website(Home):
    ...
    def website_info(self):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': actpy.service.common.exp_version()
        }
