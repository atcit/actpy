...
from actpy.exceptions import RedirectWarning, UserError, ValidationError
from actpy.tools.misc import formatLang
from actpy.tools import float_is_zero, float_compare
...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals):
        ...
        if context.get('apply_taxes') and vals.get('tax_ids'):
            # Get ids from triplets : https://www.actpy.com/documentation/10.0/reference/orm.html#actpy.models.Model.write
