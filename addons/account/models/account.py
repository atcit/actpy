...
from actpy.osv import expression
from actpy.tools.float_utils import float_round as round
from actpy.tools import DEFAULT_SERVER_DATETIME_FORMAT
from actpy.exceptions import UserError, ValidationError
...
class AccountJournal(models.Model):
    ...
    inbound_payment_method_ids = fields.Many2many('account.payment.method', 'account_journal_inbound_payment_method_rel', 'journal_id', 'inbound_payment_method',
        ...
        help="Manual: Get paid by cash, check or any other method outside of actpy.\n"\
             ...
             "Batch Deposit: Encase several customer checks at once by generating a batch deposit to submit to your bank. When encoding the bank statement in actpy,you are suggested to reconcile the transaction with the batch deposit. Enable this option from the settings.")
    outbound_payment_method_ids = fields.Many2many('account.payment.method', 'account_journal_outbound_payment_method_rel', 'journal_id', 'outbound_payment_method',
        ...
        help="Manual:Pay bill by cash or any other method outside of actpy.\n"\
