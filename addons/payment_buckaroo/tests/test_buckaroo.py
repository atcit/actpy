...
from actpy.addons.payment_buckaroo.controllers.main import BuckarooController
from actpy.tools import mute_logger


@actpy.tests.common.at_install(False)
@actpy.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('actpy.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@actpy.com',
