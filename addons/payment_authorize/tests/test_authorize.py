...
from actpy.addons.payment_authorize.controllers.main import AuthorizeController
from actpy.tools import mute_logger


@actpy.tests.common.at_install(True)
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('actpy.addons.payment_authorize.models.payment', 'ValidationError')
    ...
    def test_30_authorize_s2s(self):
        ...
        # add credential
        # FIXME: put this test in master-nightly on actpy/actpy + create sandbox account
        authorize.write({
