actpy.define('web.planner.common', function (require) {
"use strict";
        ...
        var buttons = [{
            ...
            click: function () {
                rpc.query({
                    ...
                    .then(function (data) {
                        window.location = "https://www.actpy.com/actpy-enterprise/upgrade?utm_medium=community_upgrade&num_users=" + data;
                    });
            },
        }, {
            text: _t("Cancel"),
