...
from actpy import models, api, service
from actpy.tools.translate import _
from actpy.exceptions import UserError
from actpy.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "actpy " + service.common.exp_version()['server_version']
