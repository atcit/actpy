...
from actpy.http import Controller, request, route
from actpy.addons.bus.models.bus import dispatch
...
class BusController(Controller):
    """ Examples:
    actpy.jsonRpc('/longpolling/poll','call',{"channels":["c1"],last:0}).then(function(r){console.log(r)});
    actpy.jsonRpc('/longpolling/send','call',{"channel":"c1","message":"m1"});
    actpy.jsonRpc('/longpolling/send','call',{"channel":"c2","message":"m2"});
    """
