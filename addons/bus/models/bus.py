...
import actpy
from actpy import api, fields, models, SUPERUSER_ID
from actpy.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with actpy.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not actpy.multi_process or actpy.evented:
