...
from actpy import api, release, SUPERUSER_ID
from actpy.exceptions import UserError
from actpy.models import AbstractModel
from actpy.tools.translate import _
from actpy.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to actpy's publisher warranty server to check the
