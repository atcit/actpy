...
from actpy.addons.mail.tests.test_mail_gateway import MAIL_TEMPLATE_PLAINTEXT
...
class TestMessagePost(TestMail):
    ...
    def test_post_answer(self):
        ...
        self.assertTrue(all('actpy-%d-mail.test' % self.test_pigs.id in m['references'] for m in self._mails))
