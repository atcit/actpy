...
from actpy.addons.mail.tests.common import TestMail
from actpy.tools import mute_logger


MAIL_TEMPLATE = """Return-Path: <whatever-2a840@postmaster.twitter.com>
To: {to}
cc: {cc}
Received: by mail1.actpy.com (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@actpy.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
class TestMailgateway(TestMail):
    ...
    def setUp(self):
        ...
        self.fake_email = self.env['mail.message'].create({
            ...
            'message_id': '<123456-actpy-%s-mail.test@%s>' % (self.test_public.id, socket.gethostname()),
        })

    @mute_logger('actpy.addons.mail.models.mail_thread')
    ...
    @mute_logger('actpy.addons.mail.models.mail_thread', 'actpy.models')
    ...
    @mute_logger('actpy.addons.mail.models.mail_thread', 'actpy.models', 'actpy.addons.mail.models.mail_mail')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by actpy should update thread accordingly """
    ...
    def test_message_process_model_res_id(self):
        ...
        self.assertRaises(ValueError,
                          ...
                          extra='In-Reply-To: <12321321-actpy-%d-mail.test@%s>' % (self.test_public.id, socket.gethostname()),
                          msg_id='<1198923581.41972151344608186802.JavaMail.diff1@agrolait.com>')

        # when 6.1 messages are present, compat mode is available
        # actpy 10 update: compat mode has been removed and should not work anymore
        ...
        # actpy 10 update: compat mode has been removed and should not work anymore and does not depend from hostname
        self.assertRaises(ValueError,
                          self.format_and_process,
                          MAIL_TEMPLATE, email_from='other5@gmail.com',
                          msg_id='<1.3.JavaMail.new@agrolait.com>',
                          to='noone@example.com>', subject='spam',
                          extra='In-Reply-To: <12321321-actpy-%d-mail.test@neighbor.com>' % self.test_public.id)
    ...
    def test_private_discussion(self):
        ...
        # Test: message-id
        self.assertIn('actpy-private', msg.message_id, 'message_post: private discussion: message-id should contain the private keyword')
    ...
    def test_forward_parent_id(self):
        ...
        # tmp
        from actpy.addons.mail.tests.test_mail_model import MailTest
