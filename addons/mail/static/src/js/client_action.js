actpy.define('mail.chat_client_action', function (require) {
"use strict";
            ...
            def.then(function (value) {
                if (value !== 'granted') {
                    utils.send_notification(self, _t('Permission denied'),
                        _t('actpy will not have the permission to send native notifications on this device.'));
                } else {
                    utils.send_notification(self, _t('Permission granted'),
                        _t('actpy has now the permission to send you native notifications on this device.'));
                }
            });
        }
    },
