...
from actpy.addons.payment.tests.common import PaymentAcquirerCommon
from actpy.addons.payment_paypal.controllers.main import PaypalController
...
class PaypalForm(PaypalCommon):
    ...
    def test_10_paypal_form_render(self):
        ...
        self.paypal.write({'paypal_email_account': 'tde+paypal-facilitator@actpy.com', 'fees_active': False})
        ...
        form_values = {
            'cmd': '_xclick',
            'business': 'tde+paypal-facilitator@actpy.com',
    ...
    @mute_logger('actpy.addons.payment_paypal.models.payment', 'ValidationError')
    def test_20_paypal_form_management(self):
        ...
        paypal_post_data = {
            ...
            'mc_currency': u'EUR',
            'shipping': u'0.00',
            'payer_email': u'tde+buyer@actpy.com',
