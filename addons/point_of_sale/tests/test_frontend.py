...
from actpy.tools import DEFAULT_SERVER_DATE_FORMAT
...
class TestUi(actpy.tests.HttpCase):
    def test_01_pos_basic_order(self):
        ...
        self.phantom_js("/pos/web",
                        "actpy.__DEBUG__.services['web_tour.tour'].run('pos_pricelist')",
                        "actpy.__DEBUG__.services['web_tour.tour'].tours.pos_pricelist.ready",
                        login="admin")

        self.phantom_js("/pos/web",
                        "actpy.__DEBUG__.services['web_tour.tour'].run('pos_basic_order')",
                        "actpy.__DEBUG__.services['web_tour.tour'].tours.pos_basic_order.ready",
                        login="admin")
