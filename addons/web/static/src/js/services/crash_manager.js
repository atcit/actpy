actpy.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "actpy.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: _t("actpy Session Expired"), data: {message: _t("Your actpy session expired. Please refresh the current web page.")}});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("actpy Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("actpy Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("actpy Warning"),
            buttons: [
...
core.crash_registry.add('actpy.exceptions.RedirectWarning', RedirectWarningHandler);

return CrashManager;
});

actpy.define('web.crash_manager', function (require) {
"use strict";
