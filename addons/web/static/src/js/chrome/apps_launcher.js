actpy.define('web.AppsLauncher', function (require) {
    "use strict";
...
var Apps = Widget.extend({
    ...
    render: function () {
        ...
        this._loadAllMenuData().then(function () {
            ...
            app_contents.html(QWeb.render('actpyMenuContent', {
    ...
    _appsSearch: function (ev) {
        ...
        this.$el.find('.f_apps_contents').html(QWeb.render('actpyMenuContent', {
