actpy.define('web.UserMenu', function (require) {
"use strict";
...
var UserMenu = Widget.extend({
            ...
            callback: function () {
                self._rpc({route: '/web/session/account'})
                    ...
                    .fail(function (result, ev){
                        ev.preventDefault();
                        framework.redirect('https://accounts.actpy.com/account');
                    });
            },
        });
    },
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.actpy.com/documentation/user', '_blank');
    },
    /**
     * @private
     */
    ...
    _onMenuSupport: function () {
        window.open('https://www.actpy.com/buy', '_blank');
    },
});
...
actpy.define('web.UserProfile', function (require) {
"use strict";
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            self._rpc({
                ...
                if (lang_data[0].direction == 'rtl') {
                    ...
                    // actpy RTL Custom CSS
                    var link1  = document.createElement('link');
                    link1.rel  = 'stylesheet';
                    link1.type = 'text/css';
                    link1.href = '/web/static/lib/rtl/actpy-rtl-custom.css';
