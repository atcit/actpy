actpy.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in actpy.
 *
 * The basic concurrency primitives in actpy JS are the callback, and the
...
return {
    ...
    /**
     * A (actpy) mutex is a primitive for serializing computations.  This is
