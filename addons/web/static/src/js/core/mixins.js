actpy.define('web.mixins', function (require) {
"use strict";
...
function actpyEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
actpyEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

actpyEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new actpyEvent(this, name, info);
...
actpy.define('web.ServicesMixin', function (require) {
"use strict";
