actpy.define('web.AbstractController', function (require) {
"use strict";

/**
 * The Controller class is the class coordinating the model and the renderer.
 * It is the C in MVC, and is what was formerly known in actpy as a View.
 *
...
var AbstractController = Widget.extend({
     ...
     * in the frontend (actpy frontend = public website)
     *
    ...
    /**
     * When an actpy event arrives requesting a record to be opened, this method
