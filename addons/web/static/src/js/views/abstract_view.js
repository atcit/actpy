actpy.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. actpy JS views are the
 ...
 * the word 'view' has historical significance in actpy code, so we replaced the
