actpy.define('website_sale.clear_search', function (require) {
    "use strict";
...
actpy.define('website_sale.cart', function (require) {
    "use strict";
...
actpy.define('website_sale.website_sale_category', function (require) {
    "use strict";
...
actpy.define('website_sale.website_sale', function (require) {
    "use strict";
    ...
    require("website.content.zoomactpy");
    var _t = core._t;
    ...
    $('.oe_website_sale').each(function () {
        ...
        function update_product_image(event_source, product_id) {
            ...
            if ($img.data('zoomactpy') !== undefined) {
                $img.data('zoomactpy').isReady = false;
            }
        }
    ...
    if (config.device.size_class > config.device.SIZES.XS) {
        $('.ecom-zoomable img[data-zoom]').zoomactpy({ attach: '#o-carousel-product'});
    }
});
