# -*- coding: utf-8 -*-
"""
Test various crap patterns found in actpy code to ensure they don't blow up
the parser thingie
"""
...
def test_prototype():
    ...
    actpy.define('mod2', function (require) {
