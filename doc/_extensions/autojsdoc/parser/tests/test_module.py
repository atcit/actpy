...
def test_single():
     ...
     */
    actpy.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    actpy.define('module1', function (req) {
        return 1;
    });
    actpy.define('module2', function (req) {
        return req('dep2');
    });
    actpy.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_func():
    [mod] = parse("""
    actpy.define('module', function (d) {
        /**
...
def test_export_instance():
    [mod] = parse("""
    actpy.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    actpy.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    actpy.define('m1', function (require) {
        var Class = require('Class');
...
def test_reassign():
    [m] = parse("""
    actpy.define('m', function (require) {
        var Class = require('Class');
        /** local class */
