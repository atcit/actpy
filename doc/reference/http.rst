:banner: banners/actpy_web_controllers.jpg
...
The request object is automatically set on :data:`actpy.http.request` at
the start of the request

.. autoclass:: actpy.http.WebRequest
    :members:
    :member-order: bysource
.. autoclass:: actpy.http.HttpRequest
    :members:
.. autoclass:: actpy.http.JsonRequest
    :members:

Response
========

.. autoclass:: actpy.http.Response
    :members:
    :member-order: bysource
...
:class:`~actpy.models.Model`, but can't use the same mechanism as the
...
.. autoclass:: actpy.http.Controller

and defining methods decorated with :func:`~actpy.http.route`::

    class MyController(actpy.http.Controller):
...
* decorating with :func:`~actpy.http.route` is necessary to keep the method
