...
The manifest file serves to declare a python package as an actpy module
...
``category`` (``str``, default: ``Uncategorized``)
    classification category within actpy, rough business domain for the module.
...
``depends`` (``list(str)``)
    actpy modules which must be loaded before this one, either because this
...
.. _existing categories:
     https://github.com/actpy/actpy/blob/master/actpy/addons/base/module/module_data.xml
