:banner: banners/actpy_testing_modules.jpg
...
actpy provides support for testing modules using unittest.
...
`unittest documentation`_, but actpy provides a number of utilities and helpers
related to testing actpy content (modules, mainly):

.. autoclass:: actpy.tests.common.TransactionCase
    :members: browse_ref, ref

.. autoclass:: actpy.tests.common.SingleTransactionCase
    :members: browse_ref, ref

.. autoclass:: actpy.tests.common.SavepointCase

.. autoclass:: actpy.tests.common.HttpCase
...
.. autofunction:: actpy.tests.common.at_install

.. autofunction:: actpy.tests.common.post_install

The most common situation is to use
:class:`~actpy.tests.common.TransactionCase` and test a property of a model
in each method::
...
:option:`--test-enable <actpy-bin --test-enable>` was enabled when starting the
actpy server.

As of actpy, running tests outside of the install/update cycle is not
supported.
