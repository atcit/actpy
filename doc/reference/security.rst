:banner: banners/actpy_security.jpg
...
Aside from manually managing access using custom code, actpy provides two main
...
An ORM :class:`~actpy.fields.Field` can have a ``groups`` attribute
...
* restricted fields are removed from :meth:`~actpy.models.Model.fields_get`
  responses
